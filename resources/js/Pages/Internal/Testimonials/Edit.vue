    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-xl font-semibold text-warm-900 font-display">Edit Testimonial</h1>
                    <p class="text-sm text-warm-500 mt-0.5">Update this testimonial</p>
                </div>
            </div>
        </template>
