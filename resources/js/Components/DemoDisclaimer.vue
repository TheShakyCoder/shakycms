                ...
                >
                    ...
                    <div class="p-6 sm:p-8">
                        <div class="flex items-center gap-3 mb-4">
                            <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-accent-400/15 text-accent-600">
                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <p class="mt-3 text-sm leading-relaxed text-warm-600">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener"
                                class="font-semibold text-accent-600 underline underline-offset-2 hover:text-accent-500 transition-colors"
                            >Fig Limited</a>.
                        </p>
